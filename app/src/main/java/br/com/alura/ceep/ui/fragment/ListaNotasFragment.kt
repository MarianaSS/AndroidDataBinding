...
class ListaNotasFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val viewDataBinding = ListaNotasBinding.inflate(inflater, container, false)
        viewDataBinding.vaiParaFormularioListener = View.OnClickListener { vaiParaFormulario() }
